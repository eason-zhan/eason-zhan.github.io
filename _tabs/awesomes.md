...
1. [{n} times faster than C - part one](https://owen.cafe/posts/six-times-faster-than-c/)
2. [{n} times faster than C - part two](https://owen.cafe/posts/the-same-speed-as-c/)
3. [Fibers, Oh My!](https://graphitemaster.github.io/fibers/)
4. [CUDA](https://algorithmica.org/en/cuda)
...
1. [Algorithms for Modern Hardware, HPC](https://en.algorithmica.org/hpc/) 
